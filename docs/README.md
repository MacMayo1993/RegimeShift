...
The Section 10 and Section 11 tables are not part of the production grid; they
are regenerated by `python scripts/regenerate_selection_tables.py`, deterministic
given base seed 20260713.
